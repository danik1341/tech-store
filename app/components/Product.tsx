  ...
  return (
    <div>
      <Link href={`product/${product.slug}`}>
        <div className="pointer scale-100 transform text-[#324d67] transition-transform duration-500 ease-linear hover:scale-110">
          {/* product-card */}
          <img
            src={urlFor(product.images && product.images[0].url).url()}
            className="h-64 w-64 rounded-2xl bg-[#ebebeb] transform scale-110 transition-transform duration-500 ease-linear"
          />
